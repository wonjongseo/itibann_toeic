...
import 'package:jonggack_toeic_japanese/screen/my_voca/controller/my_voca_controller.dart';
      ...
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: InkWell(
            ...
            child: Text(controller.isMyVocaPage ? '自分の単語' : 'よく間違う単語帳'),
          ),
          actions: [
