...
class WordListenScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('チャプター${int.parse(chapter) + 1}自動的に聞き'),
        ),
        body: SafeArea(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text('${(tController.currentPageIndex) + 1}番目'),
                                Text('総${wordListenController.words.length}個')
                              ],
                            ),
                          ),
                          Slider(
